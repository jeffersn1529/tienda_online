...
<h3 class="pb-3">Login Administrador</h3>
<br>
<div class="form-style">
<form action="<?php echo base_url() . 'index.php/iniciar-admin/validar-inicio-admin'; ?>" class="user" method="post">
  <div class="form-group pb-3">    
    <input type="email" placeholder="Correo electrónico" class="form-control" id="exampleInputEmail1" name="correo" aria-describedby="emailHelp">   
  </div>
  <div class="form-group pb-3">   
    <input type="password" placeholder="Contraseña" class="form-control" id="exampleInputPassword1" name="contraseña">
  </div>
